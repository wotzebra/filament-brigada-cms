...
class OnboardingStepPolicy
{
    ...
    public function view(AuthUser $authUser, OnboardingStep $onboardingStep): bool
    {
    ...
    public function update(AuthUser $authUser, OnboardingStep $onboardingStep): bool
    {
        return $authUser->can('Update:OnboardingFlow');
    }

    public function delete(AuthUser $authUser, OnboardingStep $onboardingStep): bool
    {
    ...
    public function restore(AuthUser $authUser, OnboardingStep $onboardingStep): bool
    {
        return $authUser->can('Delete:OnboardingFlow');
    }
    ...
    public function forceDelete(AuthUser $authUser, OnboardingStep $onboardingStep): bool
    {
        return $authUser->can('Delete:OnboardingFlow');
    }
    ...
    public function replicate(AuthUser $authUser, OnboardingStep $onboardingStep): bool
    {
        return $authUser->can('Create:OnboardingFlow');
    }
